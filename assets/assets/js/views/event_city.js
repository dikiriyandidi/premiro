...
functions.push(function () {
        ...
        if (actType == "del") {
            swal({
                ...
                $.ajax(
                    {
                        type: "delete",
                        url: "/cms/event/city_list/destroy/" + dataRow.id,
            ...
            let cityNameInput = $('#formModal').find('#city_name')
            let descriptionInput = $('#formModal').find('#description')
            ...
            cityNameInput.val(dataRow.city_name);
            descriptionInput.val(dataRow.description);
    ...
    if(_action_lookup.add){
        $("div.toolbar").html('<button title="Add New" class="btn btn-wknd btn-sm btn-add" act-url="/cms/event/city_list/manage"><span class="icon-span-filestyle fa fa-plus icon-text-l"></span><span>Add New</span></button>');
    }
...
function _btnActionString(){
    ...
    let editUrl = "/cms/event/city_list/manage"
